...
export async function POST(request: NextRequest) {
  try {
    ...
    const apiUrl = 'https://checkout.secure-processor.com';  // Correct API URL for hosted payment page
    ...
    const requestData = {
      checkout: {
        ...
        order: {
          amount: Math.round(amount * 100), // Amount in cents as integer (USD 2.83 = 283)
          currency: currency,
...
export async function GET(request: NextRequest) {
  try {
    ...
    const apiUrl = 'https://checkout.secure-processor.com'; // HPP API URL
