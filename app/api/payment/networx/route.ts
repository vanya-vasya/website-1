...
export async function POST(request: NextRequest) {
  try {
    ...
    const returnUrl = process.env.NETWORX_RETURN_URL || 'https://www.zinvero.com/payment/success';
    const notificationUrl = process.env.NETWORX_WEBHOOK_URL || 'https://www.zinvero.com/api/webhooks/networx';
